...
export default function App() {
  ...
  // Scroll the pipeline panel top to the sidebar top when Start is clicked.
  ...
  // Scroll to show View Results / error at bottom when pipeline finishes.
  ...
  const handleStart = useCallback(() => {
    scrollToProcessLog();
    start({ aoi, aoiName, startDate, endDate, maxCloud, hasPolygon });
  }, [start, scrollToProcessLog, aoi, aoiName, startDate, endDate, maxCloud, hasPolygon]);
      ...
      <div style={{ flex: 1, display: "grid", gridTemplateColumns: "330px 1fr", overflow: "hidden" }}>
        ...
        <div ref={sidebarRef} style={{
          ...
          <AOIPanel
            ...
            maxCloud={maxCloud}     setMaxCloud={setMaxCloud}
...
// ── AOI Metadata Panel ────────────────────────────────────────────────────────
import { computeAoiMeta } from "./utils/geoMath";
