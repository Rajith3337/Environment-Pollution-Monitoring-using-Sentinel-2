    ...
    <div style={{
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 8 }}>
          <Icon.Cloud />
          <span style={{ fontFamily: "var(--mono)", fontSize: 10, color: "var(--muted)", letterSpacing: 0.5 }}>MAX CLOUD COVER</span>
          <span style={{ marginLeft: "auto", fontFamily: "var(--mono)", fontSize: 10, color: "var(--accent)" }}>{maxCloud}%</span>
        </div>
        <input
          type="range"
          min="0" max="100"
