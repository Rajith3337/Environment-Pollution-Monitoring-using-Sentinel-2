 ...
 */
export default function InfoTooltip({ title, body, legend, width = 280, position = "right", customTrigger }) {
  ...
  return (
    <span style={{ position: "relative", display: "inline-flex", alignItems: "center" }}>
      {customTrigger ? (
        <span ref={btnRef} onClick={handleOpen} style={{ display: "inline-flex" }}>
          {customTrigger}
        </span>
      ) : (
        <button
